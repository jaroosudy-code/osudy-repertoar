...
<h1 class="text-2xl font-bold text-slate-800 mb-6">Rola: {{ $role->name }}</h1>
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
    <form method="POST" action="{{ route('admin.roles.update', $role) }}" class="space-y-6">
        ...
        <div>
            <p class="text-sm font-medium text-slate-700 mb-4">Oprávnenia — zaškrtni čo táto rola smie robiť</p>
